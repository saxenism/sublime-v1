...
contract GovernorAlpha {
    ...
    /// @notice The address of the LIME Protocol Timelock
    TimelockInterface public timelock;

    /// @notice The address of the LIME governance token
    LIMEInterface public LIME;
    ...
    function propose(
        ...
        require(
            LIME.getPriorVotes(msg.sender, sub256(block.number, 1)) >
                proposalThreshold(),
    ...
    function _castVote(
        ...
        uint96 votes = LIME.getPriorVotes(voter, proposal.startBlock);
