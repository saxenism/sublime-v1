...
interface IRepayment {
    ...
    function initializeRepayment(uint256 numberOfTotalRepayments, uint256 loanDuration) external;


    function calculateRepayAmount(address poolID, uint256 borrowRate, uint256 loanStartTime) external view returns (uint256);
