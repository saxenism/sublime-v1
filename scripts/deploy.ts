...
async function init(deployNetwork: string) {
    ...
    const creditLinesProxy: SublimeProxy = await deployHelper.helper.deploySublimeProxy(creditLinesLogic.address, proxyAdmin.address);
    ...
    const aaveYieldProxy: SublimeProxy = await deployHelper.helper.deploySublimeProxy(aaveYieldLogic.address, proxyAdmin.address);
    ...
    const compoundYieldProxy: SublimeProxy = await deployHelper.helper.deploySublimeProxy(compoundYieldLogic.address, proxyAdmin.address);
    ...
    const yearnYieldProxy: SublimeProxy = await deployHelper.helper.deploySublimeProxy(yearnYieldLogic.address, proxyAdmin.address);
    ...
    const priceOracleProxy: SublimeProxy = await deployHelper.helper.deploySublimeProxy(priceOracleLogic.address, proxyAdmin.address);
    ...
    const verificationProxy: SublimeProxy = await deployHelper.helper.deploySublimeProxy(verificationLogic.address, proxyAdmin.address);
    ...
    const poolFactoryProxy: SublimeProxy = await deployHelper.helper.deploySublimeProxy(poolFactoryLogic.address, proxyAdmin.address);
    ...
    const repaymentsProxy: SublimeProxy = await deployHelper.helper.deploySublimeProxy(repaymentsLogic.address, proxyAdmin.address);
    ...
    const extensionProxy: SublimeProxy = await deployHelper.helper.deploySublimeProxy(extensionLogic.address, proxyAdmin.address);
