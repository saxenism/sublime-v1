...
describe('Test Savings Account (with ERC20 Token)', async () => {
    ...
    describe('# When NO STRATEGY is preferred', async () => {
        ...
        it('Should successfully deposit into account another account', async () => {
            ...
            await expect(
                savingsAccount
                    .connect(userAccount)
                    .depositTo(depositValueToTest, Contracts.BAT, zeroAddress, randomAccount.address)
            )
        ...
        it('Should successfully deposit into its own accounts', async () => {
            ...
            await expect(
                savingsAccount
                    .connect(userAccount)
                    .depositTo(depositValueToTest, Contracts.BAT, zeroAddress, userAccount.address)
            )
                .to.emit(savingsAccount, 'Deposited')
    ...
    describe.skip('# When Aave STRATEGY is preferred', async () => {
        ...
        it('Should successfully deposit into its own accounts', async () => {
            ...
            await expect(
                savingsAccount
                    .connect(userAccount)
                    .depositTo(depositValueToTest, Contracts.LINK, aaveYield.address, userAccount.address)
            )
                .to.emit(savingsAccount, 'Deposited')
                .withArgs(
                    userAccount.address,
    ...
    describe('# When Yearn STRATEGY is preferred', async () => {
        ...
        beforeEach(async () => {
            ...
            await yearnYield
                .connect(admin)
                .updateProtocolAddresses(DaiTokenContract.address, DAI_Yearn_Protocol_Address);
            randomAccount = getRandomFromArray(await ethers.getSigners());
            userAccount = getRandomFromArray(await ethers.getSigners());
        ...
        it('Should successfully deposit into its own accounts', async () => {
            ...
            await expect(
                savingsAccount
                    .connect(userAccount)
                    .depositTo(depositValueToTest, Contracts.DAI, yearnYield.address, userAccount.address)
            )
                .to.emit(savingsAccount, 'Deposited')
                .withArgs(
                    userAccount.address,
    ...
    describe('# When Compound STRATEGY is preferred', async () => {
        ...
        it('Should successfully deposit into its own accounts', async () => {
            ...
            await expect(
                savingsAccount
                    .connect(userAccount)
                    .depositTo(depositValueToTest, Contracts.DAI, compoundYield.address, userAccount.address)
            )
                .to.emit(savingsAccount, 'Deposited')
                .withArgs(
                    userAccount.address,
